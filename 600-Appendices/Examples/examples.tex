...
Figure \ref{fig:YBarChart} shows an example of a vertical bar chart generated with tikzpicture (pgfplots package).
...
You can follow the \href{https://www.overleaf.com/learn/latex/LaTeX\_Graphics\_using\_TikZ:\_A\_Tutorial\_for\_Beginners\_(Part\_3)\%E2\%80\%94Creating\_Flowcharts}{instructions of overleaf on creating flowcharts} to achieve the \ref{fig:flowchart1}, \ref{fig:flowchart2}.
\begin{figure}
	\centering
