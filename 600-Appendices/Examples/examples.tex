...
References are done with command $\backslash$ref, $\backslash$pageref, $\backslash$nameref, $\backslash$eqref: Equation~\eqref{equ:Hazen-William} in chapter~\ref{cha:Appendix} \nameref{cha:Appendix} on page~\pageref{equ:Hazen-William}.
