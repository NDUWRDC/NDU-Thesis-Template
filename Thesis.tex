...
%\usepackage[backend=biber,style=apa]{biblatex}	% Author-Year citations, APA style
\usepackage[backend=bibtex,style=ieee]{biblatex} % Numerical citations, IEEE style
