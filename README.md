...
- Editors / Integrated writing environment
  - Editors dedicated to LaTeX
	  ...
	  - [TeXmaker](https://www.xm1math.net/texmaker/) 5.0.4 (January 2020), available as a portable versio
...
* __[GitHub Desktop 2.8.1](https://desktop.github.com/)__ (May 2021) also has a [portable Version](https://github.com/daemondevin/GitHubDesktopPortable).
...
|TeXstudio portable for Windows|texstudio-3.1.2-win-portable-qt5.zip                  |107 MB|/texstudio-portable|281 MB (a)|
...
|Git portable for Windows|PortableGit-2.29.2.2-64-bit.7z.exe                    |42,57|\PortableGit|272,46 |
|GitHub Desktop for Windows|GitHubDesktopSetup-x64-2.8.1.exe                                 |109|
